...
=======
>>>>>>> f03b0605051d60f56328fa7a2b6a03e082d9deb4
...
<<<<<<< HEAD
    ...
    //         subject: 'Your Transactions in CSV',
    //         body: 'Please find attached your transactions in CSV format.',
    //         attachments: [fileUri],
    //     });
    //     Alert.alert("Email Sent", "Your transactions CSV has been emailed to you.");
    // } else {
...
<<<<<<< HEAD
    ...
    const chartLabels = transactionsData.map((transaction) => format(new Date(transaction.date), "yyyy-MM-dd"));
